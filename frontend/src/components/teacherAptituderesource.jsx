...
import { deleteResource } from '../store/slices/teacherAptitudeslice'; // Adjust path if needed
import AptitudeConfirmationModal from './AptitudeconfirmationModel';
import DOMPurify from 'dompurify';
export function TeacherAptitudeResource({ resource }) {
...
export default TeacherAptitudeResource;
