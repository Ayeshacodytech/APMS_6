...
const AptitudeMCQ = () => {
    ...
    //     setSubmitting(true);
    //     try {
    //         // Dispatch the attempt thunk with the selected answer
    //         const resultAction = await dispatch(attemptMCQ({ mcqId: mcq.id, attemptData: { selectedOption } }));


    //         if (attemptMCQ.fulfilled.match(resultAction)) {
    //             const isCorrect =
    //                 selectedOption.toUpperCase() === mcq.correctAnswer.toUpperCase();
