...
import { deleteMCQ } from '../store/slices/teacherAptitudeslice'; // Adjust import if needed
import TeacherAptitudeConfirmationModal from './TeacherAptitudeconfirmationModel';

const TeacherMyAptitudeMCQCard = ({ mcq }) => {
    ...
    return (
        ...
        >
            ...
            <TeacherAptitudeConfirmationModal
                isOpen={isModalOpen}
...
export default TeacherMyAptitudeMCQCard;