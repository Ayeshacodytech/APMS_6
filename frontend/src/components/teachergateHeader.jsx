...
export function TeacherGateHeader() {
                ...
                <div className="flex flex-col md:flex-row justify-between items-center py-2 md:py-0">
                    ...
                    <div className="flex items-center gap-4 mt-2 md:mt-0">
                        <button
                            ...
                            title="Aptitude Home"
                            onClick={() => navigate("/teacher/gate/home")}
                        >
                            <svg
                                fill="#6366F1"
                                width="28px"
                        ...
                        <button
                            className="p-2 hover:bg-indigo-50 rounded-xl transition-all"
                            title="New Resource"
                            onClick={() => navigate("/teacher/gate/new/resource")}
                        >
                            <svg
                                width="28px"
                                height="28px"
                        ...
                        <button
                            className="p-2 hover:bg-indigo-50 rounded-xl transition-all"
                            title="Practice MCQs"
                            onClick={() => navigate("/teacher/gate/mcq")}
                        >
                        ...
                        <button
                            className="p-2 hover:bg-indigo-50 rounded-xl transition-all"
                            title="New MCQ"
                            onClick={() => navigate("/teacher/gate/new/mcq")}
                        >
                            <svg
                                width="28px"
                                height="28px"
                        ...
                        <button
                            className="p-2 hover:bg-indigo-50 rounded-xl transition-all"
                            title="My resources"
                            onClick={() => navigate("/teacher/gate/myresource")}
                        >
                            <svg
                                width="28px"
                                height="28px"
                        ...
                        <button
                            className="p-2 hover:bg-indigo-50 rounded-xl transition-all"
                            title="My MCQs"
                            onClick={() => navigate("/teacher/gate/mymcq")}
                        >
                            <svg
                                width="28px"
                                height="28px"
...
export default TeacherGateHeader;
