...
import { deleteResource } from '../store/slices/teacherGateslice'; // Adjust path if needed
import DOMPurify from 'dompurify';
import GateConfirmationModal from './GateconfirmationModel';
export function TeacherGateResource({ resource }) {
...
export default TeacherGateResource;
