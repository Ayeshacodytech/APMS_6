...
import { replyToComment, fetchPostById } from "../store/slices/teachercommunityslice";
import TeacherReply from "./teacherreply";

export const TeacherComment = ({ comment, postDetails }) => {
                ...
                <div className="mt-3">
                    ...
                    {showReplies &&
                        comment.replies.map((reply, index) => (
                            <TeacherReply key={index} reply={reply} />
                        ))}
                </div>
            )}
        </div>
