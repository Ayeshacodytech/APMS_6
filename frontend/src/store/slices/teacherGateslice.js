...
export const fetchMCQs = createAsyncThunk("gate/fetchMCQs", async () => {
  const response = await axios.get(
    "https://futureforge.onrender.com/api/v1/teacher/gate/mcqs",
    {
...
export const fetchMyMCQs = createAsyncThunk("gate/fetchMyMCQs", async () => {
  const response = await axios.get(
    "https://futureforge.onrender.com/api/v1/teacher/gate/mymcq",
    {
      headers: { Authorization: `Bearer ${Cookies.get("token")}` },
    }
  );
...
export const deleteMCQ = createAsyncThunk("gate/deleteMCQ", async (mcqId) => {
  await axios.delete(
    `https://futureforge.onrender.com/api/v1/teacher/gate/mcqs/${mcqId}`,
    {
      headers: { Authorization: `Bearer ${Cookies.get("token")}` },
    }
  );
...
export const fetchResources = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      "https://futureforge.onrender.com/api/v1/teacher/gate/resources",
      {
        headers: { Authorization: `Bearer ${Cookies.get("token")}` },
      }
    );
...
export const fetchMyResources = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      "https://futureforge.onrender.com/api/v1/teacher/gate/myresources",
      {
        headers: { Authorization: `Bearer ${Cookies.get("token")}` },
      }
    );
...
export const fetchResourceById = createAsyncThunk(
  ...
  async (resourceId) => {
    const response = await axios.get(
      `https://futureforge.onrender.com/api/v1/teacher/gate/resources/${resourceId}`,
      {
        headers: { Authorization: `Bearer ${Cookies.get("token")}` },
      }
    );
