...
export const fetchMCQs = createAsyncThunk("gate/fetchMCQs", async () => {
  const response = await axios.get(
    "https://futureforge.onrender.com/api/v1/gate/mcqs",
    {
...
export const fetchMCQById = createAsyncThunk(
  ...
  async (mcqId) => {
    const response = await axios.get(
      `https://futureforge.onrender.com/api/v1/gate/mcqs/${mcqId}`,
      {
        headers: { Authorization: `Bearer ${Cookies.get("token")}` },
      }
    );
  ...
  async ({ mcqId, attemptData }, { rejectWithValue }) => {
    try {
      const response = await axios.post(
        `https://futureforge.onrender.com/api/v1/gate/mcqs/${mcqId}/attempt`,
        attemptData,
        { headers: { Authorization: `Bearer ${Cookies.get("token")}` } }
      );
      return response.data;
...
export const fetchResources = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      "https://futureforge.onrender.com/api/v1/gate/resources",
      {
        headers: { Authorization: `Bearer ${Cookies.get("token")}` },
      }
    );
...
export const fetchResourceById = createAsyncThunk(
  ...
  async (resourceId) => {
    const response = await axios.get(
      `https://futureforge.onrender.com/api/v1/gate/resources/${resourceId}`,
      { headers: { Authorization: `Bearer ${Cookies.get("token")}` } }
    );
    return response.data;
  }
...
export const fetchMyResources = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      "https://futureforge.onrender.com/api/v1/gate/myresources",
      {
        headers: { Authorization: `Bearer ${Cookies.get("token")}` },
      }
    );
