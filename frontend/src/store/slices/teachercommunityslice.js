  ...
  async (page = 1, { getState }) => {
    ...
    if (page === 1 || page <= state.teachercommunity.myPostsTotalPages) {
      const response = await axios.get(
        "https://apms-6.onrender.com/api/v1/teacher/community/myposts",
        {
...
export const fetchPosts = createAsyncThunk(
  ...
  async (page = 1, { getState }) => {
    ...
    if (page === 1 || page <= state.teachercommunity.totalPages) {
      const response = await axios.get(
        `https://apms-6.onrender.com/api/v1/teacher/community/posts`,
        {
          params: { page, limit: state.teachercommunity.postsPerPage },
          headers: { Authorization: `Bearer ${Cookies.get("token")}` },
        }
...
export const fetchPostById = createAsyncThunk(
  ...
  async (postId) => {
    const response = await axios.get(
      `https://apms-6.onrender.com/api/v1/teacher/community/posts/${postId}`,
      {
        headers: { Authorization: `Bearer ${Cookies.get("token")}` },
      }
    );
...
export const createPost = createAsyncThunk(
  ...
  async (postData, { rejectWithValue }) => {
    const response = await axios.post(
      "https://apms-6.onrender.com/api/v1/teacher/community/newpost",
      postData,
      {
        headers: { Authorization: `Bearer ${Cookies.get("token")}` },
      }
...
export const deletePost = createAsyncThunk(
  ...
  async (postId) => {
    await axios.delete(
      `https://apms-6.onrender.com/api/v1/teacher/community/post/${postId}`,
      {
        headers: { Authorization: `Bearer ${Cookies.get("token")}` },
      }
    );
...
export const likePost = createAsyncThunk(
  ...
  async (postId) => {
    const response = await axios.post(
      `https://apms-6.onrender.com/api/v1/teacher/community/likes/post/${postId}`,
      {},
      { headers: { Authorization: `Bearer ${Cookies.get("token")}` } }
    );
...
export const fetchPostLikes = createAsyncThunk(
  ...
  async (postId) => {
    const response = await axios.get(
      `https://apms-6.onrender.com/api/v1/teacher/community/posts/${postId}/likes`,
      {
        headers: { Authorization: `Bearer ${Cookies.get("token")}` },
      }
    );
...
export const fetchComments = createAsyncThunk(
  ...
  async (postId) => {
    const response = await axios.get(
      `https://apms-6.onrender.com/api/v1/teacher/community/posts/${postId}/comments`,
      {
        headers: { Authorization: `Bearer ${Cookies.get("token")}` },
      }
    );
...
export const addComment = createAsyncThunk(
  ...
  async ({ postId, message }) => {
    const response = await axios.post(
      `https://apms-6.onrender.com/api/v1/teacher/community/${postId}/comments`,
      { message },
      {
        headers: { Authorization: `Bearer ${Cookies.get("token")}` },
      }
...
export const replyToComment = createAsyncThunk(
  ...
  async ({ commentId, message }) => {
    const response = await axios.post(
      `https://apms-6.onrender.com/api/v1/teacher/community/reply/${commentId}`,
      { message },
      {
        headers: { Authorization: `Bearer ${Cookies.get("token")}` },
      }
