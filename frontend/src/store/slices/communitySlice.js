...
export const fetchMyPosts = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      "http://localhost:3000/api/v1/community/myposts",
      {
...
export const fetchPostById = createAsyncThunk(
  ...
  async (postId) => {
    const response = await axios.get(
      `http://localhost:3000/api/v1/community/posts/${postId}`,
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    );
...
export const createPost = createAsyncThunk(
  ...
  async (postData, { rejectWithValue }) => {
    const response = await axios.post(
      "http://localhost:3000/api/v1/community/newpost",
      postData,
      {
        headers: { Authorization: `Bearer ${token}` },
      }
...
export const deletePost = createAsyncThunk(
  ...
  async (postId) => {
    await axios.delete(
      `http://localhost:3000/api/v1/community/post/${postId}`,
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    );
...
export const fetchPostLikes = createAsyncThunk(
  ...
  async (postId) => {
    const response = await axios.get(
      `http://localhost:3000/api/v1/community/posts/${postId}/likes`,
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    );
...
export const fetchComments = createAsyncThunk(
  ...
  async (postId) => {
    const response = await axios.get(
      `http://localhost:3000/api/v1/community/posts/${postId}/comments`,
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    );
...
export const addComment = createAsyncThunk(
  ...
  async ({ postId, message }) => {
    const response = await axios.post(
      `http://localhost:3000/api/v1/community/${postId}/comments`,
      { message },
      {
        headers: { Authorization: `Bearer ${token}` },
      }
...
export const replyToComment = createAsyncThunk(
  ...
  async ({ commentId, message }) => {
    const response = await axios.post(
      `http://localhost:3000/api/v1/community/reply/${commentId}`,
      { message },
      {
        headers: { Authorization: `Bearer ${token}` },
      }
