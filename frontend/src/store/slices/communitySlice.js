  ...
  async (page = 1, { getState }) => {
    ...
    if (page === 1 || page <= state.community.myPostsTotalPages) {
      const response = await axios.get(
        "https://apms-6.onrender.com/api/v1/community/myposts",
        {
...
export const fetchPosts = createAsyncThunk(
  ...
  async (page = 1, { getState }) => {
    ...
    if (page === 1 || page <= state.community.totalPages) {
      const response = await axios.get(
        `https://apms-6.onrender.com/api/v1/community/posts`,
        {
          params: { page, limit: state.community.postsPerPage },
          headers: { Authorization: `Bearer ${Cookies.get("token")}` },
        }
...
export const fetchPostById = createAsyncThunk(
  ...
  async (postId) => {
    const response = await axios.get(
      `https://apms-6.onrender.com/api/v1/community/posts/${postId}`,
      {
        headers: { Authorization: `Bearer ${Cookies.get("token")}` },
      }
    );
...
export const createPost = createAsyncThunk(
  ...
  async (postData, { rejectWithValue }) => {
    const response = await axios.post(
      "https://apms-6.onrender.com/api/v1/community/newpost",
      postData,
      {
        headers: { Authorization: `Bearer ${Cookies.get("token")}` },
      }
...
export const deletePost = createAsyncThunk(
  ...
  async (postId) => {
    await axios.delete(
      `https://apms-6.onrender.com/api/v1/community/post/${postId}`,
      {
        headers: { Authorization: `Bearer ${Cookies.get("token")}` },
      }
    );
...
export const likePost = createAsyncThunk(
  ...
  async (postId) => {
    const response = await axios.post(
      `https://apms-6.onrender.com/api/v1/community/likes/post/${postId}`,
      {},
      { headers: { Authorization: `Bearer ${Cookies.get("token")}` } }
    );
...
export const fetchPostLikes = createAsyncThunk(
  ...
  async (postId) => {
    const response = await axios.get(
      `https://apms-6.onrender.com/api/v1/community/posts/${postId}/likes`,
      {
        headers: { Authorization: `Bearer ${Cookies.get("token")}` },
      }
    );
...
export const fetchComments = createAsyncThunk(
  ...
  async (postId) => {
    const response = await axios.get(
      `https://apms-6.onrender.com/api/v1/community/posts/${postId}/comments`,
      {
        headers: { Authorization: `Bearer ${Cookies.get("token")}` },
      }
    );
...
export const addComment = createAsyncThunk(
  ...
  async ({ postId, message }) => {
    const response = await axios.post(
      `https://apms-6.onrender.com/api/v1/community/${postId}/comments`,
      { message },
      {
        headers: { Authorization: `Bearer ${Cookies.get("token")}` },
      }
...
export const replyToComment = createAsyncThunk(
  ...
  async ({ commentId, message }) => {
    const response = await axios.post(
      `https://apms-6.onrender.com/api/v1/community/reply/${commentId}`,
      { message },
      {
        headers: { Authorization: `Bearer ${Cookies.get("token")}` },
      }
