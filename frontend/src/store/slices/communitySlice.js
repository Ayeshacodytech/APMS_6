...
export const fetchMyPosts = createAsyncThunk("community/fetchMyPosts", async (page = 1, { getState }) => {
...
export const fetchPosts = createAsyncThunk("community/fetchPosts", async (page = 1, { getState }) => {
    const state = getState();
    // Only fetch if there are more pages or we're explicitly fetching page 1
...
export const { resetPagination, resetMyPostsPagination } = communitySlice.actions;
