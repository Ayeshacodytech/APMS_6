...
export const fetchMCQs = createAsyncThunk("aptitude/fetchMCQs", async () => {
  const response = await axios.get(
    "https://futureforge.onrender.com/api/v1/aptitude/mcqs",
    {
...
export const fetchMCQById = createAsyncThunk(
  ...
  async (mcqId) => {
    const response = await axios.get(
      `https://futureforge.onrender.com/api/v1/aptitude/mcqs/${mcqId}`,
      {
        headers: { Authorization: `Bearer ${Cookies.get("token")}` },
      }
    );
  ...
  async ({ mcqId, attemptData }, { rejectWithValue }) => {
    try {
      const response = await axios.post(
        `https://futureforge.onrender.com/api/v1/aptitude/mcqs/${mcqId}/attempt`,
        attemptData,
        { headers: { Authorization: `Bearer ${Cookies.get("token")}` } }
      );
      return response.data;
...
export const fetchResources = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      "https://futureforge.onrender.com/api/v1/aptitude/resources",
      {
        headers: { Authorization: `Bearer ${Cookies.get("token")}` },
      }
    );
...
export const fetchResourceById = createAsyncThunk(
  ...
  async (resourceId) => {
    const response = await axios.get(
      `https://futureforge.onrender.com/api/v1/aptitude/resources/${resourceId}`,
      { headers: { Authorization: `Bearer ${Cookies.get("token")}` } }
    );
    return response.data;
  }
...
export const fetchMyResources = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      "https://futureforge.onrender.com/api/v1/aptitude/myresources",
      {
        headers: { Authorization: `Bearer ${Cookies.get("token")}` },
      }
    );
