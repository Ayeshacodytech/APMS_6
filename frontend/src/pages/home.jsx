  ...
  return (
    <div className="grid grid-cols-6 bg-gradient-to-l object-fill min-h-screen">
      ...
      <div className="col-span-5">
        <div className="ml-8 min-h-screen bg-gradient-to-b from-gray-50 to-white">
          {/* Hero Section */}
          <header className="bg-indigo-500 text-white">
            <div className="container mx-auto px-6 pb-12">
              <div className="flex items-center">
                <div className="mt-16 circle relative flex items-center justify-center">
                  <svg
                    width="150"
                    height="150"
                    viewBox="0 0 200 200"
                ...
                <h1 className="font-grechen text-6xl text-white">
                  Futureforge
                </h1>
              </div>
              ...
              <div className="flex flex-col md:flex-row items-center justify-between">
                <div className="md:w-1/2 mb-8 md:mb-0">
                  ...
                  <p className="text-xl text-indigo-100 mb-8">
                    Prepare for GATE, master aptitude, build your career, and
            ...
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
              <div>
                ...
                <p className="text-gray-400">
                  Empowering students career through innovative placement and
                  skill-building.
                </p>
              </div>
              <div>
